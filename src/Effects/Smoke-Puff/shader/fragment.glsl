...
void main()
{
    ...
    newPointCoord.x += ((texture(uNoiseTex, vec2(0.5, gl_PointCoord.x * 0.2)).r * 2.0) - 1.0) * 0.2;
    newPointCoord.y += ((texture(uNoiseTex, vec2(0.5, gl_PointCoord.y * 0.2)).r * 2.0) - 1.0) * 0.2;
